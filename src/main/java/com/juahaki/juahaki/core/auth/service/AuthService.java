...
import com.juahaki.juahaki.shared.exception.AlreadyExistsException;
import com.juahaki.juahaki.shared.exception.CustomException;
import com.juahaki.juahaki.core.user.mapper.UserMapper;
...
public class AuthService implements IAuthService {
    ...
    public User createUser(SignUpRequest request) {
        ...
        if (StringUtils.hasText(request.getFcmToken())) {
            userBuilder.fcmToken(request.getFcmToken().trim())
                    .fcmTokenUpdatedAt(LocalDateTime.now());
        }
