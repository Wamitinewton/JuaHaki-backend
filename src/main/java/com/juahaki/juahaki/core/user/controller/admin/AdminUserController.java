package com.juahaki.juahaki.core.user.controller.admin;
...
import com.juahaki.juahaki.core.user.service.admin.IAdminUserManagementService;
...
public class AdminUserController {
    ...
    public ResponseEntity<ApiResponse> getAllUsers(
        ...
        AdminUserPageResponse users = adminUserManagementService.getAllUsers(request, filterRequest, pageable);
